...
for i=1:9                                 
    for ii=1:5                            
        for iii=1:10                       
            Homogenous_set=[powerconsum{ii,i}(:,iii),data_PD_31{ii,i}(:,iii),data_NFS{ii,i}(:,iii),data_HV_96{ii,i}(:,iii),data_GDPlus{ii,i}(:,iii),data_Spacing_39{ii,i}(:,iii)];            
            a=EvaluationModel(Homogenous_set(:,1),Homogenous_set(:,2:4),Homogenous_set(:,5:6));  
            Score{ii,i}(:,iii)=a;
        end
    end
end
